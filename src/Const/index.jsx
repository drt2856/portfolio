...
export const projects = [
    ...
    />,
      ...
      description: "Es una proyecto publico husado como plantilla para partir de una base al hacer uso deSpring Sequrity con token JWT",
      tecnologies_src: [
        {
          src: springSVG,
          alt: "sprin icon"
    ...
    {
      tittle: "Plantilla para uso de JWT ",
      ...
      description: "Api dedicada a aquellas personas que necesiten datos aleatoriaos personalizables de  una api  para practicar sus conocimientos en el font-end.",
      tecnologies_src: [
        {
          src: springSVG,
          alt: "sprin icon"
