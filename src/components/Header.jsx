    ...
    <section>
      <header id="header">
        <nav className="navbar navbar-expand-lg bg-body-tertiary ">
          <a className="navbar-brand mx-3 h2 " href="#">
          ...
          <div
            className="collapse navbar-collapse navbar-text "
                ...
                <ul className="dropdown-menu">
                  <li>
                    <a
                      ...
                      onClick={() =>
                        setPreferencedLanguage(LANGUAGES_SUPORTED.ESPAÑOL)
                      }
                    >
                      Español
                    </a>
                  ...
                  <li>
                    <a
                      className="dropdown-item"
                      onClick={() =>
                        setPreferencedLanguage(LANGUAGES_SUPORTED.ENGLISH)
                      }
                    >
                      English
                    </a>
      ...
      <div className="wall p-5 blue-shadow ">
        <div>
          ...
          <a
            ...
            href="https://linkedin.com/in/daniel-rodriguez-torres-571424260"
            target="_blank"
          >
