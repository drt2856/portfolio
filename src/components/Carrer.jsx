                ...
                <div id="content">
                  <ul className="timeline ">
                    ...
                    <li className="event work" data-date="14/2/2023 - ...">
                      <h3 className="mb-2">
                        {language === LANGUAGES_SUPORTED.ESPAÑOL
                          ? "Freelance BBDigital part-time"
                          : "Freelance BBDigital part-time"}
                      </h3>

                      <p>
                        {language === LANGUAGES_SUPORTED.ESPAÑOL
                          ? "Contratado a tiempo parcial como Freelancer para una empresa privada con el rol de desarrollador web full stack. Trabajar de acuerdo con las solicitudes del proyecto"
                          : "Hired part-time as a Freelancer for a private company with the role of full stack web developer. Working according to project requests"}
                      </p>
                    </li>
                    <li
                      className="event education"
                      data-date="1/3/2019 - 20/12/22"
                    >
                      <h3>
                        {language === LANGUAGES_SUPORTED.ESPAÑOL
